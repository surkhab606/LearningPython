...
if userInput == 1:
    prompt1 = round(float(input("What is the temperature you would like to convert? ")))
    result1 = prompt1 * 1.8 + 32
    print(f"The temperature you inputted in Fahrenheit is: {result1} Fahrenheit")

elif userInput == 2:
    prompt2 = round(float(input("What is the temperature you would like to convert? ")))
